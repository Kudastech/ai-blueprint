---
name: overview
description: Generate blueprint/context/project-overview.md from the two planning docs (blueprint/project-plan.md and blueprint/build-plan.md). The overview is the single AI-facing source of truth that AGENTS.md loads every session. Use when the user runs /overview, has just finished writing or editing the plans, or asks to (re)generate the project overview.
---
...
distills both plans into `blueprint/context/project-overview.md`, the single doc AGENTS.md
