...
**3. Plan, then build.** Fill in `blueprint/planning/project-plan.md` and `blueprint/planning/build-plan.md`, then run the skills (`/overview` -> `/feature` -> `/implement` -> `/complete`). See [The workflow, step by step](#the-workflow-step-by-step) below.
...
| File | What it is |
| ---- | ---------- |
| [blueprint/planning/project-plan.md](blueprint/planning/project-plan.md) | The **what & why**: problem, users, features, data, tech, monetization, UI/UX. Answer each section in a line or two. A worksheet, not an essay. |
| [blueprint/planning/build-plan.md](blueprint/planning/build-plan.md) | The **ordered feature list**: one line per feature, rough build order. No detail; that comes later, per feature. |
...
1. Fill in [blueprint/planning/project-plan.md](blueprint/planning/project-plan.md) and
   [blueprint/planning/build-plan.md](blueprint/planning/build-plan.md).
...
└── blueprint/                 (everything else the workflow needs, in one folder)
    ...
    ├── planning/              (YOU write these two)
    │   ├── project-plan.md    (what & why)
    │   └── build-plan.md      (ordered feature list)
