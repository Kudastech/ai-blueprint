...
| [context/current-feature.md](context/current-feature.md) | `/feature` | The detailed, buildable spec for the **one** feature you're building right now, with build steps `/implement` checks off as it goes (so progress survives a context clear). |
...
- `docs/features/` and git - the history of everything built
